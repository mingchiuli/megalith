...
public class BlogSearchController {
    ...
    public Result<PageAdapter<BlogDocumentVo>> selectBlogsByES(@PathVariable Integer currentPage, @PathVariable @ListValue(values = {0, 1}, message = "must commit 0 or 1") Integer flag , @RequestParam(value = "year", required = false) Integer year, @RequestParam(value = "keyword") String keyword) {
    ...
    public Result<PageAdapter<BlogEntityDto>> searchAllBlogs(@RequestParam(value = "keyword") String keyword, @RequestParam(defaultValue = "1") Integer currentPage, @RequestParam(defaultValue = "5") Integer size) {
